...
public class PlateauJeu extends JPanel {
	...
	//Plateau a deux dimensions qui représente le plateau de jeu
	Case t2[][] ;
	Case casa ; 

	//variable qui stock les coordonnée de la case séléctionné
	static int d ;
	static int e;
	...
	//Methode pour pour que le l ia pose le pion dans le plateau
